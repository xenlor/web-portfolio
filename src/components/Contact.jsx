    ...
    <RevealSection id="contacto" className="pb-32">
        <div className="max-w-3xl mx-auto text-center">
            <motion.div
                ...
                className="p-10 md:p-16 rounded-[3rem] relative overflow-hidden group hover:border-purple-500/40 transition-all shadow-2xl hover:shadow-purple-500/10 bg-linear-to-br from-white/80 to-gray-100/80 dark:from-gray-900/50 dark:to-[#0a0a0a] backdrop-blur-md border border-gray-200 dark:border-gray-800/50"
            >
                {/* Glow effect animado */}
