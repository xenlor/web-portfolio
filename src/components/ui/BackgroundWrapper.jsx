...
const BackgroundWrapper = ({ performanceMode = false }) => (
    <div className="fixed inset-0 z-0 pointer-events-none overflow-hidden transition-colors duration-500 bg-gray-50 dark:bg-[#050505]">
        ...
        bg-[size:4rem_4rem] 
        ${!performanceMode ? '[mask-image:radial-gradient(ellipse_80%_50%_at_50%_0%,#000_70%,transparent_110%)]' : 'opacity-30'}`}
        />
        ...
        {!performanceMode ? (
            ...
            // Fondo estático y ligero para modo rendimiento
            <div className="absolute inset-0 bg-gradient-to-br from-purple-500/5 via-transparent to-blue-500/5 dark:from-purple-900/10 dark:via-transparent dark:to-blue-900/10" />
        )}
    </div>
);
